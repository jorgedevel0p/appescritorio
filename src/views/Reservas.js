        ...
        <Layout_Admin>
            ...
            <div className='card my-3 mx-4 justify-center'>
                ...
                <div className='card-body'>
                    ...
                    <input type='text' name='status' className='form-control mb-2' placeholder='Estado'></input>
                    <input type='text' name='mesa_id' className='form-control mb-2' placeholder='Mesa' /*readOnly={true}*/ ></input>
                    <input type='text' name='user_id' className='form-control mb-2' placeholder='Usuario' /*readOnly={true}*/ ></input>
                    <div>
