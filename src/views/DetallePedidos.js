  ...
  const saveDetallePedido = () => {
    ...
    makeHttpRequest({
      ...
      callback: ({ ok, data }) => {
        ...
        alert('Ha guardado la información de este detalle pedido correctamente')
        console.log(JSON.stringify(data))
        resetForm()
        getDetallePedidos()
      }
  ...
  const updateDetallePedido = (id) => {
    ...
    makeHttpRequest({
      ...
      callback: ({ ok, data }) => {
        ...
        alert('Detalle Pedido se ha actualizado correctamente.')
        console.log(JSON.stringify(data))
        getDetallePedidos()
        resetForm()
      }
  ...
  const deleteDetallePedido = (id) => {
    ...
    makeHttpRequest({
      ...
      callback: ({ ok, data }) => {
        ...
        alert('Detalle Pedido se ha eliminado correctamente')
        console.log(JSON.stringify(data))
        getDetallePedidos()
      }
    })
